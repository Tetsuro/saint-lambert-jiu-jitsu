      ...
      <main className="container max-w-4xl p-8 text-sm text-slate-200">
        ...
        <section className="md:grid md:gap-8 md:grid-cols-2 items-center">
          <div className="rounded-lg overflow-hidden mb-4 md:mb-0">
           <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=485 av birch&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div></div>
          </div>
          <div>
            {t('location_desc')}
          </div>
